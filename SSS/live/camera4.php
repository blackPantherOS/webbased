...
<body>
<a href="../index.php"><img src="../pics/undo.jpg" border="0" width="20"> Kezdõlap</a> | IV. Kamera / Zóna
<br>
...
<td class="applet" nowrap><applet code=com.charliemouse.cambozola.Viewer
    ...
    <tr>
      ...
      <a href="/~<?php echo "$user_dir";?>/live/camera4.php" target="view">Ablak újratöltése</a>
<a href="/~<?php echo "$user_dir";?>/camera4actions.php" target="_parent">Mûveletek</a>
>
      </td>
    </tr>
  </tbody>
